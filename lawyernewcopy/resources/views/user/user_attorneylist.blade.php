    ...
    <div class="row"> 
      ...
      <div class="col-md-3 col-sm-6" >
        <div class="team-thumb">
          ...
          <h4>{{ $lawyer->name }}</h4>
          <h5>{{ $lawyer->user_experties }} Lawyer</h5>
          <p>{{ nl2br(substr($lawyer->service, 0, 55)) }}</p>
          <a class="btn btn-primary d-none d-lg-block Appointmentbtn" href="{{ route('user_attorney', ['id' => $lawyer->id]) }}">Get Appointment</a>
